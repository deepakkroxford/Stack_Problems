...
public class Q11_Make_Array_Beautiful {
    public static void main(String[] args) {
         ...
         * 
         * Note:An empty array is also a beautiful array. There can be many adjacent
         * integers which are different as stated above. So remove different adjacent
         * integers as described above from left to right.
         * 
         * Example 1:
         * 
         * Input: 4 2 -2 1
         ...
         * function makeBeautiful() which takes an array as an input parameter and
         * returns an array.
         * 
