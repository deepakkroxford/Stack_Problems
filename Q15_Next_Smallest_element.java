...
public class Q15_Next_Smallest_element {
    public static void main(String[] args) {
         ...
         * suggests that every student should help out a classmate who scored less marks
         * than him in chemistry and whose roll number appears after him. But the
         * students are lazy and they don't want to search too far. They each pick the
         * first roll number after them that fits the criteria. Find the marks of the
         * classmate that each student picks.
         ...
         * help_classmate() which takes the array arr[] and size of array N as input
         * parameters and returns a list of numbers. If a student is unable to find
         * anyone then output is -1.
         * 
        ...
        int result[] = ans.nextsmallerOn(arr);
        for (int i : result) {
